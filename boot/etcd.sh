...
exec etcd \
	...
	--name $(hostname -s) \
	--cert-file=$XDG_CONFIG_HOME/usernetes/node/etcd-peer.pem \
	--key-file=$XDG_CONFIG_HOME/usernetes/node/etcd-peer-key.pem \
	--peer-cert-file=$XDG_CONFIG_HOME/usernetes/node/etcd-peer.pem \
	--peer-key-file=$XDG_CONFIG_HOME/usernetes/node/etcd-peer-key.pem \
