...
ARG ROOTLESSKIT_COMMIT=v2.3.2
ARG CONTAINERD_COMMIT=v2.0.3
ARG CRIO_COMMIT=v1.32.2

ARG KUBE_NODE_COMMIT=v1.32.2

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.2
ARG CONMON_RELEASE=v2.1.13
ARG CRUN_RELEASE=1.20
ARG FUSE_OVERLAYFS_RELEASE=v1.14
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=2.1.1
ARG KUBE_MASTER_RELEASE=v1.32.2
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.32.2
ARG CNI_PLUGINS_RELEASE=v1.6.2
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.6.2-flannel1
ARG FLANNEL_RELEASE=v0.26.4
ARG ETCD_RELEASE=v3.5.18
