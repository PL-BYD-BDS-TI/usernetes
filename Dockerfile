...
ARG CONTAINERD_COMMIT=v2.1.4
ARG CRIO_COMMIT=v1.34.1

ARG KUBE_NODE_COMMIT=v1.34.1

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.3
ARG CONMON_RELEASE=v2.1.13
ARG CRUN_RELEASE=1.24
ARG FUSE_OVERLAYFS_RELEASE=v1.15
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=2.1.6
ARG KUBE_MASTER_RELEASE=v1.34.1
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.34.1
