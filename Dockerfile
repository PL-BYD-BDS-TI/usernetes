...
ARG ROOTLESSKIT_COMMIT=v2.3.6
ARG CONTAINERD_COMMIT=v2.2.1
ARG CRIO_COMMIT=v1.34.4

ARG KUBE_NODE_COMMIT=v1.35.0

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.3
ARG CONMON_RELEASE=v2.2.0
ARG CRUN_RELEASE=1.26
ARG FUSE_OVERLAYFS_RELEASE=v1.16
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=2.1.7
ARG KUBE_MASTER_RELEASE=v1.35.0
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.35.0
ARG CNI_PLUGINS_RELEASE=v1.9.0
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.9.0-flannel1
ARG FLANNEL_RELEASE=v0.28.0
ARG ETCD_RELEASE=v3.6.7
ARG CFSSL_RELEASE=1.6.5

ARG ALPINE_RELEASE=3.23
ARG GO_RELEASE=1.25.5
