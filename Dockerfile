...
ARG CONTAINERD_COMMIT=v1.7.22
ARG CRIO_COMMIT=v1.31.0

ARG KUBE_NODE_COMMIT=v1.31.1

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.1
ARG CONMON_RELEASE=v2.1.12
ARG CRUN_RELEASE=1.17
ARG FUSE_OVERLAYFS_RELEASE=v1.14
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=1.0.8
ARG KUBE_MASTER_RELEASE=v1.31.1
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.31.1
ARG CNI_PLUGINS_RELEASE=v1.5.1
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.5.1-flannel3
ARG FLANNEL_RELEASE=v0.25.6
