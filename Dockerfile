...
ARG CONTAINERD_COMMIT=v2.3.0
ARG CRIO_COMMIT=v1.36.0

ARG KUBE_NODE_COMMIT=v1.36.0

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.3
ARG CONMON_RELEASE=v2.2.1
ARG CRUN_RELEASE=1.27.1
ARG FUSE_OVERLAYFS_RELEASE=v1.16
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=2.1.7
ARG KUBE_MASTER_RELEASE=v1.36.0
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.36.0
