...
ARG CONTAINERD_COMMIT=v2.0.1
ARG CRIO_COMMIT=v1.31.4

ARG KUBE_NODE_COMMIT=v1.32.0

# Version definitions (cont.)
ARG SLIRP4NETNS_RELEASE=v1.3.1
ARG CONMON_RELEASE=v2.1.12
ARG CRUN_RELEASE=1.19.1
ARG FUSE_OVERLAYFS_RELEASE=v1.14
ARG CONTAINERD_FUSE_OVERLAYFS_RELEASE=2.1.0
ARG KUBE_MASTER_RELEASE=v1.32.0
# Kube's build script requires KUBE_GIT_VERSION to be set to a semver string
ARG KUBE_GIT_VERSION=v1.32.0
ARG CNI_PLUGINS_RELEASE=v1.6.2
ARG FLANNEL_CNI_PLUGIN_RELEASE=v1.6.0-flannel1
ARG FLANNEL_RELEASE=v0.26.2
ARG ETCD_RELEASE=v3.5.17
ARG CFSSL_RELEASE=1.6.5

ARG ALPINE_RELEASE=3.21
ARG GO_RELEASE=1.23.4
